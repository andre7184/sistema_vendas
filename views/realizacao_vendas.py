...
class RealizacaoVendas(tk.Frame):
    ...
    def create_widgets(self):
        ...
        self.label_cliente = tk.Label(self.frame_cliente, text="Cliente", font=("Arial", 14))
        self.label_cliente.pack(side=tk.LEFT, padx=5)

        self.entry_cliente = tk.Entry(self.frame_cliente)
        self.entry_cliente.pack(side=tk.LEFT, padx=5)
        self.entry_cliente.bind("<KeyRelease>", self.buscar_cliente)
        ...
        self.label_produto = tk.Label(self.frame_produtos, text="Produto:", font=("Arial", 14))
        self.label_produto.pack(side=tk.LEFT, padx=5)

        self.entry_produto = tk.Entry(self.frame_produtos, state=tk.DISABLED)
        self.entry_produto.pack(side=tk.LEFT, padx=5)
        self.entry_produto.bind("<KeyRelease>", self.buscar_produto)
        ...
        self.frame_treeview_selecionados, self.treeview_selecionados = self.create_table(self.frame_venda, columns=("ID", "Nome", "Quantidade", "Valor Unitário", "Desconto"), height=5)
        self.frame_treeview_selecionados.pack(pady=5, fill=tk.X, expand=True)
    ...
    def buscar_cliente(self, event=None):
        ...
        if clientes:
            ...
            self.entry_produto.config(state=tk.DISABLED)
    ...
    def on_treeview_click(self, event):
        ...
        if cliente_id:
            ...
            self.entry_produto.config(state=tk.NORMAL)
    ...
    def adicionar_produto(self):
        selected_item = self.treeview_produtos.selection()[0]
        produto = self.treeview_produtos.item(selected_item, "values")
        quantidade = int(self.entry_quantidade.get())
        desconto = 0.00
        self.produtos_selecionados.append((produto[0], produto[1], quantidade, produto[3], desconto))
        self.treeview_selecionados.insert("", "end", values=(produto[0], produto[1], quantidade, produto[3], desconto))
